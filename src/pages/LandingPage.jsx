...
const features = [
  {
    ...
    description:
      "Start a thread, outline the idea, and ask for feedback or partners.",
  },
  {
    title: "Get practical help",
    description:
      "Request input on pricing, growth, or product direction from peers.",
  },
  {
    title: "Build connections",
    description:
      "Find collaborators, mentors, and early customers in one place.",
  },
];
        ...
        <main className="container main">
          <section className="hero">
            <div className="hero-copy">
              ...
              <h1
                className="hero-title reveal text-balance"
                style={{ "--delay": "0.12s" }}
              >
                Where business builders connect, trade ideas, and get help.
              </h1>
              <p className="hero-text reveal" style={{ "--delay": "0.18s" }}>
                Threadline is a community-first space for business threads.
                Share ideas, get feedback, and find collaborators without the
                noise.
              </p>
              <div
          ...
          <section id="roadmap" className="section">
            ...
            <div className="wip-card reveal" style={{ "--delay": "0.1s" }}>
              ...
              <p className="wip-text">Here is what is next:</p>
